<?php
function cadMed($rua,$bairro,$estado,$cep,$numero,$cidade,
$nome,$cpf,$email,$sexo,$especialidade,$celular,$telefone,$usuario, $senha,$unidade){
include'conexao.php';
...
function CadLogMed($usuario, $senha){
    include 'conexao.php';
    $query = "INSERT INTO TB_LOGIN_MEDICO (USUARIO,SENHA) VALUES (?,?)";
    $sql= $conexao->prepare($query);
